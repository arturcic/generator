...
";
    ...
    private static string ProcessClass(ITypeSymbol classSymbol, List<IFieldSymbol> fields, ISymbol attributeSymbol, ISymbol notifySymbol)
    {
        ...
        source.WriteLine("// This file was generated by AutoNotifyGenerator");
        ...
        return source.InnerWriter.ToString();
    }
    ...
    private static void ProcessField(IndentedTextWriter source, IFieldSymbol fieldSymbol, ISymbol attributeSymbol)
    {
        ...
        source.WriteLine($"this.PropertyChanged?.Invoke(this, new System.ComponentModel.PropertyChangedEventArgs(nameof({propertyName})));");
        source.Indent--;
        source.WriteLine("}");
        source.Indent--;
        source.WriteLine("}");
